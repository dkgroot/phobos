...
unittest {
    ...
    static assert(is(typeof(incMyNumDel) == int delegate(ref uint) pure nothrow @nogc @safe));
    ...
    /* test for attributes */
    {
        ...
        static assert(is(typeof(dg_pure) == int delegate() pure nothrow @nogc @safe));
        static assert(is(typeof(dg_nothrow) == int delegate() pure nothrow @nogc @safe));
        static assert(is(typeof(dg_property) == int delegate() pure nothrow @nogc @property @safe));
        //static assert(is(typeof(dg_safe) == int delegate() @safe));
        static assert(is(typeof(dg_trusted) == int delegate() pure nothrow @nogc @trusted));
        static assert(is(typeof(dg_system) == int delegate() pure nothrow @nogc @system));
        static assert(is(typeof(dg_pure_nothrow) == int delegate() pure nothrow @nogc @safe));
